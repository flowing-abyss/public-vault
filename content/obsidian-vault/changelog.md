...
- Изменена [механика восстановления](https://t.me/flowing_abyss_chat/15290) сессии после перезапуска Obsidian
...
> [!info] Видео 
> - На Boosty [разобрал](https://boosty.to/flowing-abyss/posts/69c75cd9-5614-4ba2-b7fc-620dbb97cd35) новую систему задач для проектов на примере Product Owner-а в авиакомпании
...
- Значительным образом переработаны `home/databases/*.base`
	- `breadcrumbs.base`
		...
		- Добавлено отображение `🥢 2-hop`, которое показывает [[2hop links|опосредованно]] связанные заметки
	- `fleetings.base`
