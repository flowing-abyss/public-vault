...
[^3]: По типу того, что в Omnisearch. Кстати, в нём реализован BM25 поиск, который я также использую в своём инструменте. Можно даже сказать, что разница в том, что у меня ещё векторный поиск и RRF поверх него. Но об этом вы далее узнаете.
