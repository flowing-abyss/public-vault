...
> > Но по своей *сути* и *методологии* проделанная работа не представляет новых первичных данных. Она анализирует и синтезирует уже существующие.<br>
...
> > **Пояснение**:<br>
> > Цель книги — не представить новые данные коллегам-ученым, а просветить широкую публику.<br>
