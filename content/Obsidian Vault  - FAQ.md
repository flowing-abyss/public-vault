...
- **Meta-notes**. Тематический хаб или Roadmap
...
Как вы могли заметить, такое структурирование весьма неплохо подходит для [R&D](https://en.wikipedia.org/wiki/Research_and_development). И это неудивительно, потому что я сам занимаюсь R&D и соответстенно я заточил эту систему для R&D. Было бы странно, если я занимался R&D и делал систему не для R&D :)
...
Вы историк, который изучает историографию.
...
- 🏷 Теги
	...
	- `➖` легко свалиться в избыточность и сформировать нерасширяемую, неподдерживаемую структуру тегов
- 🔗 Ссылки
	- `➕` позволяет соединить что-угодно с чем-угодно
	- `➕` формирует у системы свойство серендипности
