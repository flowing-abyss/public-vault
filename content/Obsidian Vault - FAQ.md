...
updated: 2026-06-15T15:14:51+07:00
...
- `/editor` (команда) – редактирование текста с помощью ИИ через аннотации
...
- `/verify` (команда) – дотошная проверка утверждений, отмеченных `[?]`
