...
updated: 2026-03-17T00:15:10+07:00
share: true
...
[^7]: Пожалуй, самый крутой вариант для мультиязычного хранилища [qwen3-embedding-8b](https://openrouter.ai/qwen/qwen3-embedding-8b) (избыточно огромный контекст + в топе по [MTEB](https://huggingface.co/spaces/mteb/leaderboard)). Немного попроще, но которую можно запустить локально – [bge-m3](https://openrouter.ai/baai/bge-m3) (тоже мультиязычная и крайне неплохая по метрикам).
