...
| `Mod+P`           | показать/убрать панель превью                            |
| `Mod+O`           | открыть выбранный результат в новой вкладке              |
| `Mod+Shift+O`     | открыть все результаты в новых вкладках                  |
| `Alt+Enter`       | вставить вики-ссылку на выбранный результат под курсором |
| `Alt+Shift+Enter` | вставить все результаты как вики-ссылки под курсором     |
