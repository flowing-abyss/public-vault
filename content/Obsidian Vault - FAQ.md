...
- `/humanizer` – убирает характерные ИИ-формулировки, сохраняя смысл и авторский голос
	- В отличие от `/proofread`, работает с манерой изложения
...
- `/vault-check` – аудит всего хранилища
	...
	- По умолчанию только читает. Сначала покажет сводку по причинам. Исправлять начнёт только после того, как вы скажете что именно
