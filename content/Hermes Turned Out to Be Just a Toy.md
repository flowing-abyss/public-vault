...
Итак. Hermes позиционирует себя как агент, который растет вместе с тобой. Это закрепляется в скиллах, и каждый раз, когда появляется повторяющаяся задача, Hermes её выполняет _немножко точнее_.
