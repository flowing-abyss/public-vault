...
updated: 2026-02-28T19:11:18+07:00
share: true
...
Каждый скилл знает правильную директорию, структуру frontmatter и нужные метаданные – не нужно держать это в голове или лезть в шаблоны.
...
> - **Описание**
> 
> Заметка этого типа закладывает фундамент для понимания основного ❓ question или ❗️ claim. Она может содержать общепринятые факты, определения, историческую справку или описание доминирующей теории, внутри которой разворачивается дискуссия.<br>
> • • •
...
> - **Описание**
> 
> Это центральный узел, который запускает всю цепочку рассуждений. Он определяет общую цель и примерные границы исследования.<br>
> • • •
...
> - **Описание**
> 
> В оригинальном методе этот узел описывается как «примечательный или удивительный паттерн или феномен». Это может быть прямое наблюдение, неожиданный результат эксперимента, интересная цитата или закономерность в данных, которая ещё не до конца осмыслена.<br>
> • • •
...
> - **Описание**
> 
> Это утверждение, которое можно оспорить, доказать или опровергнуть (оно должно быть фальсифицируемым). Это может быть гипотеза, вывод, интерпретация или любая другая позиция, требующая обоснования.<br>
> • • •
...
> - **Описание**
> 
> Это могут быть данные, результаты экспериментов, ссылки на авторитетные источники, логические выводы или математические расчёты. Заметка этого типа отвечает на вопрос: «Почему я должен согласиться с этим утверждением?»<br>
> • • •
