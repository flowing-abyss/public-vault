...
<font color="#72AEFD">Когда я редактировал эту статью, то заметил, что из первых букв собирается слово <font color="#d13f8d">СОН</font>. Если бы такое появилось в англоязычном сообществе, то все бы пищали от восторга, так как в их рационе появился ещё один странный, но полезный акроним.</font>
